<div class="row">
    ...
    <div class="col-sm-4">
        <div class="card card-affix affix-4">
            <div class="card-head">
                <div class="tools">
                    <a class="btn btn-default btn-ink" href="{{ route('communitygarden.index') }}">
                        <i class="md md-arrow-back"></i>
                        Back
                    </a>
                </div>
            ...
            <div class="card-actionbar">
                <div class="card-actionbar-row">
                    ...
                    <input type="submit" name="draft" class="btn btn-info ink-reaction" value="Save Draft">
                    <input type="submit" name="publish" class="btn btn-primary ink-reaction" value="{{ isset($communitygarden) && $communitygarden->is_published ? 'Save' : 'Publish' }}">
                </div>
            </div>
        </div>
    </div>
